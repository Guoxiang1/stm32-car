...
void MPU6050_Init(void)
{
	...
	else												 //MPU6050״ָ̬ʾ�� STM32���İ� PC13 ��ɫ������Ϊ������
	 {
...
/*
 *  @param[out] gyro        Gyro data in hardware units.    							���������ݵ�Ӳ����λ��
 *  @param[out] accel       Accel data in hardware units.    							Ӳ����λ�ļ������ݡ�
 *  @param[out] quat        3-axis quaternion data in hardware units.    Ӳ����Ԫ�е�������Ԫ������
 *  @param[out] timestamp   Timestamp in milliseconds.							     ʱ����Ժ���Ϊ��λ��
 *  @param[out] sensors     Mask of sensors read from FIFO.								��FIFO��ȡ����������ģ��
 *  @param[out] more        Number of remaining packets.								ʣ�౨������
*/
void MPU6050_Pose(void)
{
	
	dmp_read_fifo(gyro, accel, quat, &sensor_timestamp, &sensors,&more);	 //gyro, accelȫ�ֱ���  ���������ݴ����������
	...
	**/
	...
	if(sensors & INV_WXYZ_QUAT )    //Pitch,Roll,Yaw;ȫ�ֱ���
	{
		q0 = quat[0] / q30;	
		q1 = quat[1] / q30;
		q2 = quat[2] / q30;
